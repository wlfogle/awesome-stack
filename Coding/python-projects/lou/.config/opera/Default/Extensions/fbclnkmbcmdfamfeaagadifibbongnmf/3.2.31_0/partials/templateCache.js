angular.module('myjdWebextensionApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/controllers/autograbber.html',
    "<div class=\"flex-container\">\n" +
    "    <div id=\"side-nav\">\n" +
    "        <h2>MyJDownloader - Browser Extension</h2>\n" +
    "        <div class=\"autograbber-tabs-container\">\n" +
    "            <h3><b>AutoGrabber</b>\n" +
    "                <small style=\"float:right;margin-right:16px;\"\n" +
    "                       ng-if=\"dataView.raw.data.active && dataView.raw.data.active.length > 0\">\n" +
    "                    {{dataView.raw.data.active.length}} active {{dataView.raw.data.active.length == 1? \"tab\": \"tabs\"}}\n" +
    "                </small>\n" +
    "            </h3>\n" +
    "            <div ng-if=\"dataView.raw.data.active == null || dataView.raw.data.active.length === 0\"\n" +
    "                 class=\"autograbber-tabs-empty\">\n" +
    "                <div class=\"icon\"><i class=\"fa fa-exclamation-circle\"></i></div>\n" +
    "                <div class=\"description\">Start AutoGrabber in one of your tabs to collect links</div>\n" +
    "            </div>\n" +
    "            <div ng-click=\"showTab(tab.tab.id)\"\n" +
    "                 ng-class=\"{'nav-item': tabId != tab.tab.id, 'nav-item-active': tabId == tab.tab.id}\"\n" +
    "                 ng-repeat=\"tab in dataView.raw.data.active\">\n" +
    "                <div class=\"title\">{{tab.tab.title}}</div>\n" +
    "                <p class=\"meta\">{{(tab.data.length === 0 ? \"No \" : tab.data.length)}} links captured</p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <div class=\"no-tab-selected\" ng-if=\"tabId == null\">\n" +
    "        <div class=\"description\">Select a tab to continue</div>\n" +
    "    </div>\n" +
    "    <div id=\"tab-data\" ng-if=\"tabId != null && dataView.raw != null\">\n" +
    "        <div class=\"empty-message\" ng-if=\"dataView.raw.length === 0 || dataView.filtered == null\">\n" +
    "            <div class=\"autograbber-links-empty\">\n" +
    "                <div class=\"icon\"><i class=\"fa fa-link\"></i></div>\n" +
    "                <div class=\"description\">Collect links to get started</div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"data-container\" ng-if=\"dataView.filtered != null\">\n" +
    "            <h2>{{dataView.filtered.tab.title}}</h2>\n" +
    "            <div id=\"header\">\n" +
    "                <div class=\"selection-control\">\n" +
    "                    <a ng-click=\"selectAll()\"\n" +
    "                       class=\"selection-control-button\"\n" +
    "                       href=\"\"><i class=\"fa fa-check-square\"></i>&nbsp;All</a>\n" +
    "                    <a ng-click=\"clearSelection()\" class=\"selection-control-button\" href=\"\">\n" +
    "                        <i class=\"fa fa-minus-square\"></i>&nbsp;Clear</a></div>\n" +
    "                <div class=\"filter-control\">\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.IMAGE)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.IMAGE].active == true,inactive: filterState[FilterTags.IMAGE].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-image\"></i>&nbsp;Image<span\n" +
    "                            class=\"count\">{{filterState[FilterTags.IMAGE] == null ? 0 : filterState[FilterTags.IMAGE].count}}</span></a>\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.AUDIO)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.AUDIO].active == true,inactive: filterState[FilterTags.AUDIO].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-headphones\"></i>&nbsp;Audio<span class=\"count\">{{filterState[FilterTags.AUDIO] == null ? 0 : filterState[FilterTags.AUDIO].count}}</span></a>\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.DOCUMENT)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.DOCUMENT].active == true,inactive: filterState[FilterTags.DOCUMENT].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-file\"></i>&nbsp;Document<span class=\"count\">{{filterState[FilterTags.DOCUMENT] == null ? 0 : filterState[FilterTags.DOCUMENT].count}}</span></a>\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.VIDEO)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.VIDEO].active == true,inactive: filterState[FilterTags.VIDEO].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-film\"></i>&nbsp;Video<span\n" +
    "                            class=\"count\">{{filterState[FilterTags.VIDEO] == null ? 0 : filterState[FilterTags.VIDEO].count}}</span></a>\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.ARCHIVE)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.ARCHIVE].active == true,inactive: filterState[FilterTags.ARCHIVE].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-archive\"></i>&nbsp;Archive<span class=\"count\">{{filterState[FilterTags.ARCHIVE] == null ? 0 : filterState[FilterTags.ARCHIVE].count}}</span></a>\n" +
    "                    <a\n" +
    "                            ng-click=\"toggleFilterState(FilterTags.OTHER)\"\n" +
    "                            ng-class=\"{active: filterState[FilterTags.OTHER].active == true,inactive: filterState[FilterTags.OTHER].active == false}\"\n" +
    "                            class=\"filter-item active\" href=\"\"><i\n" +
    "                            class=\"fa fa-question\"></i>&nbsp;Other<span class=\"count\">{{filterState[FilterTags.OTHER] == null ? 0 : filterState[FilterTags.OTHER].count}}</span></a>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            <div id=\"links\">\n" +
    "                <div class=\"empty-links-view\"\n" +
    "                     ng-if=\"dataView.unfiltered == null ||dataView.unfiltered.length === 0\">\n" +
    "                    <div class=\"icon\"><i class=\"fa fa-link\"></i></div>\n" +
    "                    <div class=\"description\">No links captured</div>\n" +
    "                </div>\n" +
    "                <div class=\"empty-filtered-view\"\n" +
    "                     ng-if=\"(dataView.unfiltered != null && dataView.unfiltered.length > 0) && (dataView.filtered.links == null || dataView.filtered.links.length === 0)\">\n" +
    "                    <div class=\"icon\"><i class=\"fa fa-link\"></i></div>\n" +
    "                    <div class=\"description\">No links match the filter criteria</div>\n" +
    "                </div>\n" +
    "                <div class=\"link-item\" ng-repeat=\"link in dataView.filtered.links\"\n" +
    "                     ng-class=\"{'link-item selected': link.selected, 'link-item': !link.selected}\"\n" +
    "                     ng-click=\"link.selected = !link.selected;updateSelectionCount()\">\n" +
    "                    <input style=\"float:left;\" type=\"checkbox\" ng-model=\"link.selected\"/>\n" +
    "                    <div class=\"title\">{{link.linkText.split('/').pop().split('#')[0].split('?')[0]}}</div>\n" +
    "                    <div class=\"meta\">{{link.linkText}}</div>\n" +
    "                    <i\n" +
    "                            style=\"float:right; color:#777; font-size: 2em;margin-top:-12px;\" ng-class=\"{'fa fa-image': link.filterTag == FilterTags.IMAGE,\n" +
    "                    'fa fa-headphones': link.filterTag == FilterTags.AUDIO,\n" +
    "                    'fa fa-file': link.filterTag == FilterTags.DOCUMENT,\n" +
    "                    'fa fa-video': link.filterTag == FilterTags.VIDEO,\n" +
    "                    'fa fa-archive': link.filterTag == FilterTags.ARCHIVE,\n" +
    "                    'fa fa-question': link.filterTag == FilterTags.OTHER}\"></i>\n" +
    "                </div>\n" +
    "                <div style=\"clear:both\"></div>\n" +
    "                <div class=\"footer-container\">\n" +
    "                    <div ng-if=\"dataView.selectionCount > 0\" class=\"selection-count\"><span>{{dataView.selectionCount}}\n" +
    "                    {{dataView.selectionCount == 1? \"link\": \"links\"}} selected</span>&nbsp;\n" +
    "                        <a href=\"#\"\n" +
    "                           class=\"button-jdownloader-add\"\n" +
    "                           ng-if=\"dataView.selectionCount >0\"><i\n" +
    "                                class=\"fa fa-plus\"></i>&nbsp;Add to JDownloader\n" +
    "                        </a>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
  ...
  $templateCache.put('partials/controllers/settings.html',
    ...
    "        <label\n" +
    "                for=\"clicknload_active\">\n" +
    "            <input type=\"checkbox\" id=\"clicknload_active\"\n" +
    "                   ng-model=\"settings[settingsKeys.CLICKNLOAD_ACTIVE.key]\"/>{{'ui_settings_cnl_via_myjd' |\n" +
    "            translate}}</label>\n" +
    "\n" +
    "        <div style=\"clear:both;\"></div>\n" +
    "        <p class=\"description\">\n" +
    ...
    "        <label\n" +
    "                for=\"clipboard_observer_running\">\n" +
    ...
    "        <label\n" +
    "                for=\"context_menu_flat\">\n" +
    "            <input type=\"checkbox\" id=\"context_menu_flat\"\n" +
    "                   ng-model=\"settings[settingsKeys.CONTEXT_MENU_SIMPLE.key]\"/>{{'ui_settings_checkbox_simple_contextmenu'\n" +
    "            | translate}}</label>\n" +
    "\n" +
    "        <div style=\"clear:both;\"></div>\n" +
    "        <p class=\"description\">\n" +
    ...
    "        <label for=\"useAddLinksCheckbox\"><input type=\"checkbox\" id=\"useAddLinksCheckbox\"\n" +
    ...
    "            | translate}} <i\n" +
    "                title=\"{{'ui_settings_add_links_default_values_unset_title'\n" +
    "            | translate}}\"\n" +
    ...
    "                       ng-model=\"settings[settingsKeys.COUNTDOWN_ACTIVE.key]\"/>\n" +
    ...
    "                    | translate}}</span>\n" +
    "                <input style=\"width:40px; padding: 4px 0px 4px 4px; margin-right: 16px;\"\n" +
    "                       type=\"number\"\n" +
    "                       id=\"countdownValue\"\n" +
    "                       ng-model=\"settings[settingsKeys.COUNTDOWN_VALUE.key]\"/>\n" +
    "            </div>\n" +
    ...
    "                <input type=\"checkbox\" id=\"deepDecrypt\"\n" +
    "                       ng-model=\"settings[settingsKeys.DEFAULT_DEEPDECRYPT.key]\"/>\n" +
    ...
    "            | translate}}\" ng-click=\"unset(settingsKeys.DEFAULT_DEEPDECRYPT.key)\"\n" +
    ...
    "                </label>&nbsp;\n" +
    "                <i title=\"{{'ui_settings_add_links_default_values_unset_title'\n" +
    "            | translate}}\" ng-click=\"unset(settingsKeys.DEFAULT_AUTOSTART.key)\"\n" +
    "                   class=\"fa fa-remove unset\"></i>\n" +
    "            </div>\n" +
    ...
    "            | translate}}</a></div>\n" +
    "        <div><a href=\"#\" ng-click=\"changelog()\"><i class=\"fa fa-external-link\"\n" +
    "                                                   aria-hidden=\"true\"></i>&nbsp;{{'ui_settings_changelog_title'\n" +
    "            | translate}}</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>"
  ...
  $templateCache.put('partials/controllers/toolbar.html',
    ...
    "    </div>\n" +
    "    <div ng-if=\"((state.error.message && state.error.message.length > 0)  === true)\"\n" +
    "         class=\"errorMessage\"\n" +
    "         id=\"errorMessage\">\n" +
    ...
    "                <div>\n" +
    "                    <div class=\"typeicon\">\n" +
    "                        <span ng-if=\"historyItem.type === 'text'\"\n" +
    "                              title=\"Text\"\n" +
    ...
    "                                class=\"fa fa-link\"\n" +
    "                                aria-hidden=\"true\"></i></span>\n" +
    "                        <span title=\"Click'n'Load\" ng-if=\"historyItem.type === 'cnl'\" class=\"historyItemTypeIcon\"\n" +
    "                        ><img width=\"20px\" src=\"images/icon32.png\"/></span>\n" +
    "\n" +
    "                    </div>\n" +
    ...
    "                        </div>\n" +
    "                        <div ng-click=\"historyItem.expanded = false\" ng-if=\"historyItem.expanded\">{{previewText}}<span>&nbsp;<small><a>less ...</a></small></span>\n" +
    "                        </div>\n" +
    "                        <div class=\"meta\">\n" +
    ...
    "                    </div>\n" +
    "                    <div class=\"actions\">\n" +
    "        <span ng-click=\"removeRequest(historyItem.id)\"\n" +
  ...
  $templateCache.put('partials/directives/myautograbberlistitem.html',
    "<div class=\"autograbber-listitem\">\n" +
    "    <div class=\"tab-title\">\n" +
    "        {{tabData.tab.title}}\n" +
    "    </div>\n" +
    "    <div class=\"primary-actions\">\n" +
    "        {{tabData.data.length}} links captured\n" +
    "    </div>\n" +
    "    <div class=\"secondary-actions\">\n" +
    "        <a\n" +
    "                style=\"margin-left: 8px; font-size: 0.8em; color: #00181c; text-decoration: none;\"\n" +
    "                href=\"\"\n" +
    "                title=\"{{'ui_autograbber_go_to_tab' | translate}}\"\n" +
    "                ng-click=\"goToTab()\"><i\n" +
    "                class=\"fa fa-chevron-circle-right\" aria-hidden=\"true\"></i>&nbsp;go to tab</a>\n" +
    "        <a\n" +
    "                style=\"margin-left: 8px; font-size: 0.8em; color: #00181c; text-decoration: none;\"\n" +
    "                href=\"\"\n" +
    "                title=\"{{'ui_autograbber_open_data_view' | translate}}\"\n" +
    "                ng-click=\"openDataView()\"><i\n" +
    "                class=\"fa fa-folder-open\" aria-hidden=\"true\"></i>&nbsp;show links</a>\n" +
    "        <a\n" +
    "                style=\"margin-left: 8px; font-size: 0.8em; color: #c3325f; text-decoration: none;\"\n" +
    "                href=\"\"\n" +
